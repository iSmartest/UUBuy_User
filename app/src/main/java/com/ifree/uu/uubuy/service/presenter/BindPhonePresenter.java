...
public class BindPhonePresenter implements Presenter {
    ...
    public void getSearchBindPhone(String userPhone,String password,String code,String sessionId,String uid,String mContent){
        final Dialog dialog = ProgressDialog.createLoadingDialog(mContext,mContent);
        dialog.show();
        mCompositeSubscription.add(manager.getSearchBindPhone(userPhone,password,code,sessionId,uid)
