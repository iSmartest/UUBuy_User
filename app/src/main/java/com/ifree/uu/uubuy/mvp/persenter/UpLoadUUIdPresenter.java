 ...
 * Description:
 */
public class UpLoadUUIdPresenter implements Presenter {
    private DataManager manager;
    private CompositeSubscription mCompositeSubscription;
    private Context mContext;
    private ProjectView mUserInfoView;
    private UserInfoBean mUserInfoBean;
    public UpLoadUUIdPresenter(Context mContext){
    ...
    public void upLoadUUId(String systemName, String uuid, String uid){
        mCompositeSubscription.add(manager.upLoadUUId(systemName,uuid,uid)
