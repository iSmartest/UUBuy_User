 ...
 * Description:
 */
public class GetCouponPresenter implements Presenter {
    ...
    public void getCoupon(String uid, String couponId, String mContent) {
        final Dialog dialog = ProgressDialog.createLoadingDialog(mContext, mContent);
        dialog.show();
        mCompositeSubscription.add(manager.getCoupon(uid,couponId)
