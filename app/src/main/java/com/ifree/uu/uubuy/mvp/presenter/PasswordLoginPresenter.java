 ...
 * Description:
 */
public class PasswordLoginPresenter implements Presenter {
    private DataManager manager;
    private CompositeSubscription mCompositeSubscription;
    private Context mContext;
    private ProjectView mUserInfoView;
    private UserInfoEntity mUserInfoEntity;
    public PasswordLoginPresenter(Context mContext){
    ...
    public void getSearchPassWordLogin(String userPhone,String password,String mContent){
        final Dialog dialog = ProgressDialog.createLoadingDialog(mContext,mContent);
        dialog.show();
        mCompositeSubscription.add(manager.getSearchPassWordLogin(userPhone,password)
