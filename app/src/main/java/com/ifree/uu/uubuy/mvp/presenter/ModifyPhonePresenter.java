 ...
 * Description:
 */
public class ModifyPhonePresenter implements Presenter {
    private DataManager manager;
    private CompositeSubscription mCompositeSubscription;
    private Context mContext;
    private ProjectView mUserInfoView;
    private UserInfoEntity mUserInfoEntity;
    public ModifyPhonePresenter(Context mContext){
    ...
    public void getSearchModifyPhone(String userPhone,String password,String code,String sessionId,String uid,String mContent){
        final Dialog dialog = ProgressDialog.createLoadingDialog(mContext,mContent);
        dialog.show();
        mCompositeSubscription.add(manager.getSearchModifyPhone(userPhone,password,code,sessionId,uid)
