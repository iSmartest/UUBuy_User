...
public class StringUtils {
    ...
    public static boolean isMatchesPhone(Context context, String user) {
        ...
        if (TextUtils.isEmpty(user)) {
            ToastUtils.show(R.string.error_input_phone);
            return false;
        }
    ...
    public static boolean isMatchesPwd(Context context, String pwd) {
        if (TextUtils.isEmpty(pwd)) {
            ToastUtils.show(R.string.error_input_pwd_fail_info_tips);
            return false;
        }
    ...
    public static boolean isMatchesVerification(Context context, String text) {
        if (TextUtils.isEmpty(text)) {
            ToastUtils.show(R.string.error_input_verification);
            return false;
        }
        if (!StringUtils.isMatchesVerification(text)) {
            ToastUtils.show(R.string.error_input_verification_fail_info);
            return false;
        }
        return true;
    }
