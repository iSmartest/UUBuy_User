 ...
 * Description:
 */
public class ThirdLoginPresenter implements Presenter {
    private DataManager manager;
    private CompositeSubscription mCompositeSubscription;
    private Context mContext;
    private ProjectView mUserInfoView;
    private UserInfoEntity mUserInfoEntity;
    public ThirdLoginPresenter(Context mContext){
    ...
    public void getSearchThirdLogin(String thirdUid,String nickName,String userIcon,String type,String mContent){
        final Dialog dialog = ProgressDialog.createLoadingDialog(mContext,mContent);
        dialog.show();
        mCompositeSubscription.add(manager.getSearchThirdLogin(thirdUid,nickName,userIcon,type)
                ...
                .subscribe(new Observer<UserInfoEntity>() {
                    ...
                    public void onError(Throwable e) {
                        e.printStackTrace();
                        dialog.dismiss();
                        mUserInfoView.onSuccess(RequestResult.getError(e));
                    }
