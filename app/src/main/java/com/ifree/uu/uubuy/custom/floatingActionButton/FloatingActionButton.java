...
public class FloatingActionButton extends ImageButton {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int size = getDimension(
                mType == TYPE_NORMAL ? R.dimen.fab_size_mini : R.dimen.fab_size_normal);
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mVisible = true;
        mColorNormal = getColor(R.color.text_blue);
    ...
    private Drawable createDrawable(int color) {
        ...
        if (mShadow && !hasLollipopApi()) {
            Drawable shadowDrawable = getResources().getDrawable(mType == TYPE_NORMAL ? R.drawable.fab_shadow_mini
        ...
        if (hasLollipopApi()) {
            ...
            setOutlineProvider(new ViewOutlineProvider() {
                ...
                public void getOutline(View view, Outline outline) {
                    int size = getDimension(mType == TYPE_NORMAL ? R.dimen.fab_size_mini
