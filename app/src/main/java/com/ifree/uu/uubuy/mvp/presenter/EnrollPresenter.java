...
import com.ifree.uu.uubuy.mvp.manager.DataManager2;
 ...
 * Description:
 */
public class EnrollPresenter implements Presenter {
    private DataManager2 manager;
    private CompositeSubscription mCompositeSubscription;
    private Context mContext;
    private ProjectView mUserInfoView;
    private UserInfoEntity mUserInfoEntity;
    public EnrollPresenter(Context mContext){
        this.mContext = mContext;
    }
    @Override
    public void onCreate() {
        manager = new DataManager2(mContext);
    ...
    public void searchEnroll(String uid,String userPhone,String mContent){
        final Dialog dialog = ProgressDialog.createLoadingDialog(mContext, mContent);
        dialog.show();
        mCompositeSubscription.add(manager.searchEnroll(uid,userPhone)
