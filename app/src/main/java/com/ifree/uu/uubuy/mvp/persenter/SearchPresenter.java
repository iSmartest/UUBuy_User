...
public class SearchPresenter implements Presenter {
    ...
    private ProjectView mSearchView;
        ...
        mCompositeSubscription.add(manager.getSearchInfo(longitude,latitude,townAdCode,page,keyWord,uid,searchType)
                ...
                .subscribe(new Observer<SearchBean>() {
                    ...
                    public void onCompleted() {
                        dialog.dismiss();
                        if (mSearchBean != null){
                            mSearchView.onSuccess(mSearchBean);
                            Log.i("TAG", "onSearch: " + new Gson().toJson(mSearchBean));
                        }
                    }
                    ...
                    public void onError(Throwable e) {
                        e.printStackTrace();
                        dialog.dismiss();
                        mSearchView.onError(RequestResult.getError(e));
                    }
