...
import com.ifree.uu.uubuy.custom.customBean.ImageTitleBean;
...
//        imageTitleBean.setTitle(title);
    ...
    private void setIndicator() {
        ...
        llDot.getChildAt(0).setBackgroundResource(R.drawable.lunbo_selected);
        ...
        vpImageTitle.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                for (int i = 0; i < llDot.getChildCount(); i++) {
                    if (i == position - 1) {// 被选中
                        llDot.getChildAt(i).setBackgroundResource(R.drawable.lunbo_selected);
                        if (!isLarge.get(i)) {
                        ...
                        llDot.getChildAt(i).setBackgroundResource(R.drawable.lunbo_unselected);
                        if (isLarge.get(i)) {
