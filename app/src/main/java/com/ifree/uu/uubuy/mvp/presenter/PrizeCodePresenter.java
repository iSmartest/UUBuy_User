 ...
 * Description:
 */
public class PrizeCodePresenter implements Presenter {
    private DataManager2 manager;
    private CompositeSubscription mCompositeSubscription;
    private Context mContext;
    private ProjectView mUserInfoView;
    private UserInfoEntity mUserInfoEntity;
    public PrizeCodePresenter(Context mContext){
    ...
    public void searchPrizeCode(String uid,String mContent){
        final Dialog dialog = ProgressDialog.createLoadingDialog(mContext, mContent);
        dialog.show();
        mCompositeSubscription.add(manager.searchPrizeCode(uid)
