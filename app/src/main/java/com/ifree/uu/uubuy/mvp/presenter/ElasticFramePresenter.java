 ...
 * Description:
 */
public class ElasticFramePresenter implements Presenter {
    private DataManager2 manager;
    private CompositeSubscription mCompositeSubscription;
    private Context mContext;
    private ProjectView mUserInfoView;
    private UserInfoEntity mUserInfoEntity;
    public ElasticFramePresenter(Context mContext){
    ...
    public void searchElasticFrame(String uid){
        mCompositeSubscription.add(manager.searchElasticFrame(uid)
