...
public class HotKeywordPresenter implements Presenter {
    ...
    private HotKeyWordBean mHotKeyWordBean;
    ...
    public void getSearchHotKeyword(String mContent){
        ...
        mCompositeSubscription.add(manager.getSearchHotKeyword()
                ...
                .subscribe(new Observer<HotKeyWordBean>() {
                    @Override
                    public void onCompleted() {
                        dialog.dismiss();
                        if (mHotKeyWordBean != null){
                            mHotKeyWordView.onSuccess(mHotKeyWordBean);
                            Log.i("TAG", "onHotKeyword: " + new Gson().toJson(mHotKeyWordBean));
                        }
                    }
                    ...
                    public void onNext(HotKeyWordBean hotKeyWordBean) {
                        mHotKeyWordBean = hotKeyWordBean;
                    }
                }));
    }
}
